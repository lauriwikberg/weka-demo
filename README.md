...
**Analysis:**
- Predicted overall ratings (1–5) from review text using word frequency features and Random Forest  
- Modeled review helpfulness (≥15 votes) using binary classification, applying SMOTE to address class imbalance  
- Predicted reviewer influence based on behavioral features (e.g., number of reviews, helpful votes, mobility)
